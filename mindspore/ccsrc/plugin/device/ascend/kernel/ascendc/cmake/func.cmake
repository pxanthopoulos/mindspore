...
function(add_bin_compile_target)
  cmake_parse_arguments(BINCMP "" "TARGET;OPS_INFO;COMPUTE_UNIT;IMPL_DIR;ADP_DIR;OUT_DIR;INSTALL_DIR;OPC_PATH" "" ${ARGN})
  ...
  add_custom_target(${BINCMP_TARGET}_gen_ops_config ALL
                    COMMAND ${ASCEND_PYTHON_EXECUTABLE} ${PROJECT_SOURCE_DIR}/cmake/util/insert_simplified_keys.py -p ${BINCMP_OUT_DIR}/bin
                    COMMAND ${ASCEND_PYTHON_EXECUTABLE} ${PROJECT_SOURCE_DIR}/cmake/util/ascendc_ops_config.py -p ${BINCMP_OUT_DIR}/bin
